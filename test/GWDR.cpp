...
TEST_CASE("GWDR: basic flow")
{
    ...
    REQUIRE_THAT(diagnostic.AICc, Catch::WithinAbs(2580.754861403243, 1e-8));
    REQUIRE_THAT(diagnostic.RSquare, Catch::WithinAbs(0.898063766825, 1e-8));
    REQUIRE_THAT(diagnostic.RSquareAdjust, Catch::WithinAbs(0.722050880566, 1e-8));
}
